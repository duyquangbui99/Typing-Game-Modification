...
public class HighscoreTable : MonoBehaviour {
    ...
    private void Awake() {
        ...
        if (highscores == null) {
            ...
            AddHighscoreEntry(999, "AI");
            AddHighscoreEntry(100, "Random Player");
            AddHighscoreEntry(90, "Professor");
            // Reload
    ...
    {
        int score = SaveData.score;
        string name = SaveData.playerName;
    ...
    private void AddHighscoreEntry(int score, string name) {
        ...
        {
            highscores.highscoreEntryList.RemoveAt(11);
        }
